...
public sealed partial class MutinySystem : SharedMutinySystem
{
    ...
    private void AddMakeMutineerVerb(GetVerbsEvent<Verb> args)
    {
        ...
        if (!HasComp<MutineerComponent>(args.Target))
        {
            Verb mutineer = new()
            {
                Text = Loc.GetString("rmc-mutiny-verb-make-mutineer"), // RuMC edit
                ...
                Message = Loc.GetString("rmc-mutiny-verb-make-mutineer"), // RuMC edit
            };
        ...
        if (!HasComp<MutineerLeaderComponent>(args.Target))
        {
            Verb leader = new()
            {
                Text = Loc.GetString("rmc-mutiny-verb-make-mutineer-leader"), // RuMC edit
                Category = VerbCategory.Antag,
                ...
                Impact = LogImpact.High,
                Message = Loc.GetString("rmc-mutiny-verb-make-mutineer-leader"), // RuMC edit
            };
