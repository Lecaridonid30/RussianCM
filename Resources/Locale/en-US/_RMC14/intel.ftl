...
rmc-intel-console-start-typing = You start typing in intel into the computer...
rmc-intel-console-nothing-to-add = You start typing in intel into the computer... and you have nothing new to add...
rmc-intel-console-distracted = You get distracted and lose your train of thought, you'll have to start the typing over...
rmc-intel-console-nothing-after = ...and you have nothing new to add...
rmc-intel-console-done = ...and done! You uploaded { $amount } entries!

rmc-ui-tech-console-title = Tech Control Console
