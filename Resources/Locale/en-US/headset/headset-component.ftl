...
chat-radio-message-wrap = [color={$color}][font={$fontType} size={$fontSize}]{$channel}: "{$message}"[/font][/color]
chat-radio-message-wrap-bold = [color={$color}][font={$fontType} size={$fontSize}]{$channel}: [bold]"{$message}"[/bold][/font][/color]
