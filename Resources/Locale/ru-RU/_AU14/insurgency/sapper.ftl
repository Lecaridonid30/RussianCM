...
# Sapper's Workbench.
insfor-sapper-workbench-title = Верстак сапера
insfor-sapper-workbench-tab-gunsmithing = Оружейное дело
insfor-sapper-workbench-tab-fabrication = Изготовление
insfor-sapper-workbench-no-weapon-loaded = Оружие не загружено
insfor-sapper-workbench-attachment-slots = Слоты модулей
insfor-sapper-workbench-load-weapon-slots = Загрузите оружие, чтобы увидеть его слоты.
insfor-sapper-workbench-buffs-debuffs = Усиления / штрафы
insfor-sapper-workbench-no-modifiers = Модификаторы модулей не применены.
insfor-sapper-workbench-slot-row = { $slot }: { $attachment }
insfor-sapper-workbench-slot-empty = пусто
insfor-sapper-workbench-add-attachment = +Добавить
insfor-sapper-workbench-remove-attachment = -Снять
insfor-sapper-workbench-materials = Материалы
insfor-sapper-workbench-no-materials-loaded = Материалы не загружены
insfor-sapper-workbench-eject = Извлечь
insfor-sapper-workbench-loose-help = Справка по свободным ингредиентам
