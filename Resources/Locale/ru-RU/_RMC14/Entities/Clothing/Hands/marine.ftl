...
ent-RMCHandsDeluxeMarine = продвинутые боевые перчатки
  .desc = Боевые перчатки, отделанные тканью, похожей на золотую. Изолированные, модные и способные защитить мягкие руки, которые они, вероятно, покрывают.
...
ent-CMHandsBlackMarine = боевые перчатки морпеха
  .desc = Тактические перчатки морпеха стандартной выдачи. Надпись: 'связаны Ассоциацией Вдов Морпехов'.
