...
ent-RMCHeadBeretGeneral = бронированный берет генерала
  .desc = Прочный берет генерала. Защищает и выглядит стильнее, чем кажется. Пожалуйста, не меняйте его на шлем.

ent-RMCHeadCapGeneral = бронированная фуражка генерала
  .desc = Прочная фуражка генерала. Защищает лучше, чем кажется. Пожалуйста, не меняйте её на шлем.
