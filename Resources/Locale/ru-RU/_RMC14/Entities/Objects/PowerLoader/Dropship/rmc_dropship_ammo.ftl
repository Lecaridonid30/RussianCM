...
ent-RMCDropshipAttachmentAmmoLaunchableSentry = турель воздушного десантирования A/C-49-P
    .desc = Турель, способная защищать зону от вторжений противника. Может заряжаться в пусковую установку турелей LAG-14.
...
ent-AU14DropshipAttachmentAmmoRocketThermobaricTwo = BLU-176 «Избыточное давление»
     .desc = BLU-176 «Избыточное давление» — термобарическая топливно-воздушная бомба, младший брат BLU-200 «Дыхание Дракона». Распылённая топливная смесь при подрыве создаёт вакуум, нанося серьёзный урон всем на своём пути. Может заряжаться в управляемую пусковую установку LAU-444.
...
ent-AU14DropshipAttachmentAmmoCBU250 = CBU-250 «Накрытый стол»
    .desc = CBU-250 «Накрытый стол» — кассетный боеприпас, предназначенный для применения против легкобронированных машин и пехоты противника. При срабатывании боеприпас разделяется на двенадцать суббоеприпасов малой мощности, неравномерно рассеивая их на большой площади. Может заряжаться в управляемую пусковую установку LAU-444.

ent-AU14DropshipAttachmentAmmoCBU607 = CBU-607 «Стрелок по тарелочкам»
    .desc = CBU-607 «Стрелок по тарелочкам» — кассетный ракетный блок на четыре снаряда, предназначенный для применения против среднебронированных машин и пехоты противника. При срабатывании каждый снаряд разделяется на два суббоеприпаса средней мощности, плотно покрывая зону прилёта. Может заряжаться в управляемую пусковую установку LAU-444.
