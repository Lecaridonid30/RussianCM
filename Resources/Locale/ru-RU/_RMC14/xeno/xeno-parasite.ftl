...
rmc-xeno-cant-throw = Мы не можем швырнуть {$target}!
...
rmc-xeno-parasite-ghost-carrier-none = {$xeno} не носит лицехватов.
rmc-xeno-parasite-ghost-carrier-reserved = {$xeno} сохранил лицехватов для себя.
rmc-xeno-parasite-ghost-carrier-dead = Со смертью {$xeno} все его лицехваты погибли.

rmc-xeno-parasite-carrier-death = Рой мелких тварей пытается сбежать из разрывающейся плоти {$xeno}!

rmc-xeno-parasite-larva-claim-title = Стать личинкой?
rmc-xeno-parasite-larva-claim-message = Вы хотите стать личинкой, если этот носитель родит одну?
rmc-xeno-parasite-larva-claim-yes = Да
rmc-xeno-parasite-larva-claim-no = Нет
