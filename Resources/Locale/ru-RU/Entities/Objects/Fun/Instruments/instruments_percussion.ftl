...
ent-MusicBoxInstrument = музыкальная шкатулка
    .desc = Её мелодия заставляет вас не бояться страшных существ.
...
ent-WoodblockInstrument = коробочка
    .desc = Достаточно долгое прослушивание заставляет её звучание въедаться в вашу память.

ent-ReverseCymbalsInstrument = ревёрс-цимбалы
