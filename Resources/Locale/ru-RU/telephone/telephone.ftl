...
chat-telephone-message-wrap = [color={ $color }][font={ $fontType } size={ $fontSize }]"{ $message }" [/font][/color]
chat-telephone-message-wrap-bold = [color={ $color }][font={ $fontType } size={ $fontSize }][bold]"{ $message }"[/bold][/font][/color]
